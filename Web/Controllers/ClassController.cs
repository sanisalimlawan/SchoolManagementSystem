...
namespace Web.Controllers
{
    ...
    {
        private readonly IClassRepo _secRepo;
        private readonly ILocationsSevices _loc;
        public ClassController(IClassRepo secrepo, ILocationsSevices loc)
        {
            _secRepo = secrepo;
            _loc = loc;
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            ViewData["sections"] = new SelectList(await _loc.GetAllSectionAsync(), "Id", "Name");

            ViewData["teachers"] = new SelectList(await _loc.GetAllFormMastersAsync(), "Id", "FullName");
            return View();
        }
        [HttpPost]
